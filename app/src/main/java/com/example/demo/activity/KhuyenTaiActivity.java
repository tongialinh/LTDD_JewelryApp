...
import com.example.demo.adapter.KhuyenTaiAdapter;
...
public class KhuyenTaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khuyen_tai);
    ...
    private void getData(int page) {
        ...
        .subscribe(
                sanPhamMoiModel -> {
                    if(sanPhamMoiModel.isSuccess()){
                        if(adapterDt == null){
                            ...
                            adapterDt = new KhuyenTaiAdapter(getApplicationContext(), sanPhamMoiList);
                ...
                throwable -> {
                    Toast.makeText(getApplicationContext(), "Không kết nối được với sever. Vui lòng kiểm tra kết nối Internet", Toast.LENGTH_SHORT).show();
                }
        ));
    }
